 ...
 * ARM timer.
 *
 * This file contains structures, macros and functio definitions 
 * for ARM timer, following Section 14 of the BCM2835 Peripherals PDF.
 * 
...
/** @brief Prescaling 256 */
#define RPI_ARMTIMER_CTRL_PRESCALE_256  ( 2 << 2 )

//#define RPI_ARMTIMER_CTRL_PRESCALE_4096  ( 3 << 2 )

/** @brief 1 : Timer interrupt enabled */
#define RPI_ARMTIMER_CTRL_INT_ENABLE    ( 1 << 5 )
/** @brief 0 : Timer interrupt disabled */
#define RPI_ARMTIMER_CTRL_INT_DISABLE   ( 0 << 5 )

/** @brief 1 : Timer enabled */
#define RPI_ARMTIMER_CTRL_ENABLE        ( 1 << 7 )
/** @brief 0 : Timer disabled */
...
/**
 * Get memory mapped area for ARM timer
 *
...
/**
 * Initializing function for ARM timer
 */
extern void RPI_ArmTimerInit(void);

#endif // RPI_ARMTIMER_H
